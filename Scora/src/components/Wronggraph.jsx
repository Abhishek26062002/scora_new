...
const Wronggraph = () => {
    ...
    var options = {
      ...
      fill: {
        ...
        gradient: {
          ...
          gradientToColors: ['#ff0000'], // Red gradient end color
          stops: [0, 100]
        }
      },
      colors: ['#ff0000'], // Red gradient start color
      labels: [''] // Hide labels
    };

    var chart = new ApexCharts(document.querySelector("#wrongchart"), options);
    chart.render();
  ...
  return (
    <div className='box'>
      ...
      <p className='progress-para' style={{ color: "#162f0f" }}>Wrong : 40/30</p>
    </div>
  );
}

export default Wronggraph;
